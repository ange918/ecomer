...
const el=await pg.$('#why'); await el.scrollIntoView(); await new Promise(r=>setTimeout(r,250));
await el.screenshot({ path: OUT+'/why2-desktop.png' });
await pg.setViewport({ width:390, height:844, deviceScaleFactor:2, isMobile:true });
await pg.goto('http://localhost:4173/', { waitUntil:'load' });
await new Promise(r=>setTimeout(r,400));
const el2=await pg.$('#why'); await el2.scrollIntoView(); await new Promise(r=>setTimeout(r,250));
await el2.screenshot({ path: OUT+'/why2-mobile.png' });
