...
function DevenirVendeur() {
    ...
    return (
      <AuthShell title="Vérifiez votre email" subtitle="Dernière étape" back="/login">
        <div className="vendor-done">
          ...
          <p>
            Un email de confirmation a été envoyé à <strong>{form.email}</strong>. Cliquez dessus
  ...
  return (
    <AuthShell
      ...
      subtitle="Vendez votre gaz et vos accessoires sur GazExpress."
      back={step === 2 ? undefined : '/'}
    >
